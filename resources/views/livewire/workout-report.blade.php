<div >
    <div class="inter mt-1">
        <div class="pgtabs pgtab2 btn-group btn-group-sm" id="report-tab">
            <button type="button" wire:click="getWeeklyReport" class="btn text-white  {{ $activeTab === 'weekly' ? 'activeTab' : '' }}">Weekly</button>
            <button type="button" wire:click="getMonthlyReport"class="btn text-white  {{ $activeTab === 'monthly' ? 'activeTab' : '' }}">Monthly</button>
            <button type="button" wire:click="getAnnualReport" class="btn text-white  {{ $activeTab === 'annual' ? 'activeTab' : '' }}">Annually</button>
